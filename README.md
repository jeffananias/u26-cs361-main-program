...
It runs entirely on Python in a terminal. No frameworks or libraries were used except for the [tinytag](https://pypi.org/project/tinytag/) library. No LLMs were used to 
